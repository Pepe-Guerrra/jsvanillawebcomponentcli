let fs;_877‍.x([["createComponent",()=>createComponent]]);_877‍.w("fs",[["default",["fs"],function(v){fs=v}]]);

       async function createComponent(componentName) {

  // toma el componentName, lo separa en las partes, lo pasa a minuscula y agrega un gion para este resultado(component-name)
  ...
  let stream = fs.createWriteStream(`./src/components/${componentName}/${componentName}.js`);
    ...
    // Crea el texto dentro del archivo
